...
const ChatBox = () => {
  ...
  const [isSendingImage, setIsSendingImage] = useState(false); // ✅ Added
  ...
  const sendImage = async (e) => {
    try {
      setIsSendingImage(true); // ✅ Start loader
      ...
      setIsSendingImage(false); // ✅ Stop loader
    }
  };
  ...
  return chatUser ? (
    <div className='chat-box h-[90vh] bg-[#f1f5ff] relative'>
      ...
      <div className="chat-user p-[10px] px-[15px] flex items-center gap-[10px] border-b-[1px] border-[#c6c6c6]">
        ...
        <p className='flex items-center gap-[5px] flex-1 font-medium text-[#393939]'>
          ...
          {Date.now() - chatUser.userData.lastSeen <= 70000 && (
            <img className='w-[15px]' src={assets.green_dot} alt="" />
          )}
        </p>
      ...
      <div className="chat-msg h-[calc(100%-70px)] pb-[50px] overflow-scroll flex flex-col-reverse">
        {/* ✅ Loader */}
        {isSendingImage && (
          <div className="s-msg flex items-end justify-end px-[15px] gap-[5px]">
            <div className="relative w-[227px] h-[227px] bg-gray-300/60 rounded-xl mt-7">
          ...
          msg.sId === userData.id ? (
            <div key={index} className="s-msg flex items-end justify-end px-[15px] gap-[5px]">
              {msg.image ? (
                <img
                  ...
                  style={{ maxWidth: "50%", maxHeight: "300px", height: "auto" }}
                />
              ) : (
                <p className="msg text-white bg-[#077EFF] p-[8px] max-w-[300px] text-[14px] font-light rounded-[8px_8px_0px_8px] mb-[30px] mt-3">
                  {msg.text}
                </p>
              )}
            ...
            <div key={index} className="r-msg flex items-end justify-start px-[15px] gap-[5px]">
              ...
              {msg.image ? (
                ...
                <p className="msg text-white bg-[#077EFF] p-[8px] max-w-[300px] text-[14px] font-light rounded-[8px_8px_8px_0px] mb-[30px] mt-3">
                  {msg.text}
                </p>
              )}
            </div>
